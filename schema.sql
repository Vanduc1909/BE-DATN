...
CREATE TABLE "product_variants" (
  ...
  "productId" int,
  "sku" varchar UNIQUE,
  "color" varchar, -- e.g. Red, Blue, Black
  "colorHex" varchar, -- e.g. #FF0000
  "price" decimal,
  "originalPrice" decimal,
  "stockQuantity" int DEFAULT 0,
  "isAvailable" boolean DEFAULT true,
  "images" json, -- Optional variant-specific images
  "createdAt" datetime DEFAULT (now()),
  "updatedAt" datetime DEFAULT (now()),
...
CREATE TABLE "order_items" (
  ...
  "variantId" int,
  "variantSku" varchar, -- Snapshot
  "variantColor" varchar, -- Snapshot
...
ALTER TABLE "inventory_logs" ADD FOREIGN KEY ("variantId") REFERENCES "product_variants" ("id");
